  ...
  return (
    <aside className="rounded-2xl border border-dashed border-white/15 bg-white/[0.04] p-4 text-center text-sm text-slate-300">
      ...
      <p className="mb-3 text-xs text-slate-400">
        Ad placement: {placement}. Free users may see ads after matches and on dashboards. Support ChessPlay to remove promotional ad placements where ads are enabled.
      </p>
