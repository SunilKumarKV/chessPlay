...
export default function Board() {
  ...
  const handleSquareClick = useCallback(
    ...
    [gameState, settings, board, dispatch, coordsToSquare],
  );
  ...
  const handleDragStart = useCallback(
    ...
    [board, gameState.game, settings.moveMethod, dispatch, coordsToSquare],
  );
  ...
  const isSelected = useCallback(
    ...
    [gameState.selectedSquare, squareToCoords],
  );
  ...
  const isLegalDest = useCallback(
    ...
    [gameState.possibleMoves, coordsToSquare],
  );
  ...
  const isLastMove = useCallback(
    ...
    [gameState.lastMove, squareToCoords],
  );
      ...
      <AnimatePresence>
        {promotionPending && (
          ...
          >
            ...
            >
              {["Q", "R", "B", "N"].map((pt) => {
                const promoPiece = `${promotionPending.color}${pt}`;
                return (
                  <motion.button
                    key={pt}
